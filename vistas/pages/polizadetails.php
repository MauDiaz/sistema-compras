                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        <div class="input-group input-group-sm col-sm-12" >
                          ...
                          <input type="text" style="width: 100%" class="form-control" id="cost-after" name="cost-after" <?php echo'value="'.$answer["cost_after"].'"';?> pattern="[0-9]*\.?[0-9]*" >
                        </div>
                      </div>

                        <div class="form-group">
                        <div class="input-group input-group-sm col-sm-12" >
                          <label class="mr-2" for="departament">balance :</label>
                          <input type="text" style="width: 100%" class="form-control" id="balance" name="balance" value="" readonly="">
                        </div>
                      </div>
                    ...
                    <div class="col-12 col-sm-4  text-center align-self-center box-approval">
                        <h3 class="">¿APROBAR BALANCE?</h3>
                        <h6>POR FAVOR CONFIRME HACIENDO</h6><h6 class="text-success m-3">CLICK</h6>  
                        <div class="button-group m-3">
                            <button type="button" class="btn btn-danger mr-3 btn-reject-poliza"><i class="icon ion-ios-thumbs-down"></i> Rechazar</button>
                            <button type="submit" class="btn btn-success btn-approval-poliza"><i class="icon ion-ios-thumbs-up"></i> Aprobar</button>

                              <?php

                              $approvalPoliza = new polizasController(); 
                              $approvalPoliza ->ctrApprovalPoliza();
