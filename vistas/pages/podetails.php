        ...
        <div class="row mb-2">
            ...
            echo'<!-- TITULO DE LA TARJETA -->
                ...
                <div class="card-header">
                    <h3 class="card-title">DETALLE DE ORDEN DE COMPRA-</h3><h3 class="card-title text-primary text-lowercase">#'.$po.'</h3> <h3 class="card-title text-primary text-lowercase" id=""></h3>  
                </div>
                      ...
                      <div class="col-12 col-sm-2" style="border-top: dashed .1px;border-left: dashed .1px;border-bottom: dashed .1px;">
                        ...
                        <div class="form-group">
                            <div class="input-group input-group-sm col-sm-12">
                              ...
                              <input type="text" style="width: 100%" class="form-control form-control-sm bg-info" id="req-type" name="" <?php echo'value="'.$answer["request_order_id"].'"';?>readonly>
                              <input type="text" style="width: 100%" class="form-control form-control-sm" id="appr-id" name="quot-id" <?php echo'value="'.$po.'"';?>hidden>
                            </div>
                        </div>
                  ...
                  <div class="form-group">
                    <div class="input-group col-sm-12">
                      ...
                      echo   '<img src="'.$answer["staff_photo"].'" alt="" id="next-approber" style="width: 31px; height: 31px">';
                          ...
                          ?>
                          <input type="text" style="width: 100%" class="form-control" id="approver1" name=""<?php echo'value="'.$answer["staff_name"].'"';?> readonly>
                        </div>
                    </div>
                  </div>
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-sm  col-sm-12">
                         <label class="mr-2" for="company">Empresa</label>
                                <input type="text" style="width: 100%"class="form-control" id="company" name="" <?php echo'value="'.$answer["branch_name"].'"';?> readonly>
                        </div>
                      </div>
                    ...
                    <div class="col-12 col-sm-2" style="border-top: dashed .1px;border-right: dashed .1px;border-bottom: dashed .1px;">
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-sm col-sm-12" >
                          ...
                          <input type="text" style="width: 100%" class="form-control" id="departament" name="" <?php echo'value="'.$answer["department_name"].'"';?> readonly>
                        </div>
                      </div>
    ...
    <!-- TERMINA INFO PROVEEDOR -->
                ...
                <div class="form-group " id="aproved-array"></div>
                    ...
                    <div class="col-12 col-sm-4  text-center align-self-center box-approval">
                        <h3 class="">DETALLE DE LA ORDEN DE COMPRA</h3>
                        <!-- <h6>POR FAVOR CONFIRME HACIENDO</h6><h6 class="text-success m-3">CLICK</h6>
                        <div class="button-group m-3">
                            <button type="button" class="btn btn-danger mr-3 btn-reject-quot"><i class="icon ion-ios-thumbs-down"></i> Rechazar</button>
                            <button type="submit" class="btn btn-success btn-approval-quot"><i class="icon ion-ios-thumbs-up"></i> Aprobar</button>
 -->
                              <?php

                              // $approvalQuoting = new approvalController();
                              // $approvalQuoting ->ctrApprovalQuotation();
                  ...
                  <?php
                        ...
                        foreach ($answerList as $key => $value){
                         ...
                         echo '<tr class="appr-det-list text-center">
                            <td class="text-center update-quantity-row">'.$value["quantity"].'</td>
                            <td class="d-none">'.$value["product_id"].'</td>
                            <td>'.$value["product_name"].'</td>
                            <td>'.$value["meassure_unit_name"].'</td>
                            <td>'.$value["enlace"].'</td>
                            <td class="text-center update-price-row">'.$value["price_list"].'</td>
                            <td>'.$costo.'</td>
                            </td> 
                            </tr>';};
                        ?>
